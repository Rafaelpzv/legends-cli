...
if (cliArg) {
    ...
    console.log(display_1.c.dim("     Agora rode: ") + display_1.c.white("legends-cli\n"));
    process.exit(0);
}
// ─── Open browser helper ──────────────────────────────────────────────────────
...
function getApiKey() {
    ...
    if (!key) {
        console.log(display_1.c.orange("\n  ⚠  Nenhuma API Key da Riot encontrada!\n"));
        console.log("  " + display_1.c.white("Para obter sua chave, siga os passos:"));
        console.log(display_1.c.dim("  1. Acesse:  ") + display_1.c.accent("https://developer.riotgames.com"));
        console.log(display_1.c.dim("  2. Faça login com sua conta Riot"));
        console.log(display_1.c.dim("  3. Copie sua") +
            display_1.c.white(" Development API Key") +
            display_1.c.dim(" no painel"));
        console.log(display_1.c.dim("  4. Configure rodando o comando:\n"));
        console.log("     " +
            display_1.c.green("legends-cli") +
            display_1.c.white(" RGAPI-xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx") +
            "\n");
        console.log(display_1.c.dim("  ↗  Abrindo o portal da Riot no navegador...\n"));
